define('constant', function(){
    ...
    constant.CATEGORIES = {
        "過濾器": ["不鏽鋼濾心機", "不鏽鋼袋濾機", "純PP濾殼、塑膠濾殼", "過濾器配件", "鈦過濾器", "不銹鋼磁力設備與台車"],
    ...
    constant.SERIES = {
        "過濾器": {
            "不鏽鋼濾心機": ["ALS", "AHS", "AF", "AL", "AH_AV", "AM", "SG", "SM", "SLS"],
    ...
    */
    constant.ITEMS = {
        ...
        "O型環": {
            ...
            "range": "各機型皆可選購",
            "spec": {
                "材質": "NBR、EPDM、Silicon、Viton 、PTFE 包 Viton/Silicon"
            }
        },
        ...
        "APD": {
            ...
            "title": "台車式磁力設備過濾器",
            "subtitle": "",
            "range": "RO 前置過濾、PCW 過濾、循環過濾、化學品製程、回收水過濾、飲料業、老舊管路鐵屑吸附",
            "spec": {
                "台車本體材質": "SUS304, SUS316, SUS316L",
                "過濾器本體材質": "SUS304, SUS316, SUS316L",
                "磁力設備高斯": "3000GS~13000GS",
                "進出口": "1”~4”牙口, 法蘭, 衛生級接頭",
                "排放口": "3/4” PT-M",
                "排氣口": "1/4” PT-F",
                "Oring 材質(標準)": "EPDM",
                "Oring 材質(選購)": "Viton, Teflon 包 Viton",
                "設計壓力": "15kg/cm² (225psi)",
                "操作壓力": "10kg/cm² (150psi)",
                "表面處理(標準)": "外部電解, 內部酸洗",
                "表面處理(選購)": "X-Ray, EP 電解",
    ...
    constant.POPULAR_PRODUCTS = ["ALS", "AM", "SM"];
